...
Sets up and syncs configuration of Karabiner Elements.

## Usage
Applying `tool-karabiner` will make sure `karabiner` is configured as specified.
...
### Dotfiles
`tool-karabiner.configsync` will recursively apply templates from 

- `salt://dotconfig/<user>/karabiner` or
